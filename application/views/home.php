            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image  ">
                            <img src="<?php echo base_url();?>assets/images/5.jpg" alt="product" class="img-responsive ">
                        </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image2 ">
                            <img src="<?php echo base_url();?>assets/images/6.jpg" alt="product" class="img-responsive ">
                          </div>
                    </div>
                </div>
        </div>
        ...
        <div class="covers-main ">
            <div class="container">
                <div class="gallery-image">
                  ...
                  <div class="img-box">
                    <img src="<?php echo base_url();?>assets/images/7.jpg" alt="product" class="img-responsive ">
                  ...
                  <div class="img-box">
                    <img src="<?php echo base_url();?>assets/images/8.jpg" alt="product" class="img-responsive ">
                    <div class="transparent-box">
                      <div class="caption">
                        <p>Skin Care</p>
                        <p class="opacity-low">Salon</p>
                  ...
                  <div class="img-box">
                    <img src="<?php echo base_url();?>assets/images/9.jpg" alt="product" class="img-responsive ">
                    <div class="transparent-box">
                      <div class="caption">
                        <p>Nail Art</p>
                        <p class="opacity-low">Salon</p>
                  ...
                  <div class="img-box">
                    <img src="<?php echo base_url();?>assets/images/10.jpg" alt="product" class="img-responsive ">
                    <div class="transparent-box">
                      <div class="caption">
                        <p>Hair style</p>
                        <p class="opacity-low">Salon</p>
                  ...
                  <div class="img-box">
                    <img src="<?php echo base_url();?>assets/images/11.jpg" alt="product" class="img-responsive ">
                    <div class="transparent-box">
                      <div class="caption">
                        <p>Nail Art</p>
                        <p class="opacity-low">Salon</p>
                    ...
                    <ul>
                        <li>
                            <div class="slider-info">
                                <div class="d-grid hh14-text">
                                    <div class="hh14-info">
                                        <img src="<?php echo base_url();?>assets/images/c1.jpg" alt="product" class="img-responsive ">
                        ...
                        <li>
                            <div class="slider-info">
                                <div class="d-grid hh14-text">
                                    <div class="hh14-info">
                                        <img src="<?php echo base_url();?>assets/images/c2.jpg" alt="product" class="img-responsive ">
                                        <p class="para">Consectetur adipisicing Lorem ipsum dolor sit amet,elit, sed do
                                            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                            minim incididunt ut labore et dolore magna aliqua incididunt ut labore et dolore magna aliqua. Ut enim ad
                                            minim incididunt ut labore et dolore magna aliqua.</p>
                        ...
                        <li>
                            <div class="slider-info">
                                <div class="d-grid hh14-text">
                                    <div class="hh14-info">
                                        <img src="<?php echo base_url();?>assets/images/c3.jpg" alt="product" class="img-responsive ">
                                        <p class="para">Consectetur adipisicing Lorem ipsum dolor sit amet,elit, sed do
                                            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                            minim incididunt ut labore et dolore magna aliqua incididunt ut labore et dolore magna aliqua. Ut enim ad
                                            minim incididunt ut labore et dolore magna aliqua.</p>
        ...
        <div class="container">
            <div class=" row">
                <div class="col-lg-6 back-image">
                    <img src="<?php echo base_url();?>assets/images/b1.jpg" alt="product" class="img-responsive ">
                </div>
