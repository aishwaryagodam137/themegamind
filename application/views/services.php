        ...
        <div class="container">
            <div class="row about-about">
                <div class="col-lg-4 col-md-6 col-sm-6 propClone">
                 <img src="<?php echo base_url();?>assets/images/5.jpg" alt="product" class="img-responsive about-me">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 propClone about-line-top">
                 <img src="<?php echo base_url();?>assets/images/6.jpg" alt="product" class="img-responsive about-me">
                    <div class="about-grids  ">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 propClone about-line-top">
                 <img src="<?php echo base_url();?>assets/images/12.jpg" alt="product" class="img-responsive about-me">
                    <div class="about-grids  ">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 about-line-top propClone">
                 <img src="<?php echo base_url();?>assets/images/8.jpg" alt="product" class="img-responsive about-me">
                    <div class="about-grids  ">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 about-line-top propClone">
                 <img src="<?php echo base_url();?>assets/images/9.jpg" alt="product" class="img-responsive about-me">
                    <div class="about-grids ">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 about-line-top propClone">
                 <img src="<?php echo base_url();?>assets/images/10.jpg" alt="product" class="img-responsive about-me">
                    <div class="about-grids  ">
        ...
        <div class="container">
            <div class="row service-treat">
                <div class="col-lg-6 image-col">
                    <img src="<?php echo base_url();?>assets/images/b2.jpg" alt="">
                </div>
