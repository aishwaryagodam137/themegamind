    ...
    <div class="content-with-photo4-block ">
        <div class="container">
            ...
            <div class="cwp4-image col-xl-6">
                <img src="<?php echo base_url();?>assets/images/b2.jpg" alt="product" class="img-responsive about-me">
            </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6 team-team">
				  <div class="our-team">
					<a href="#page">
					<img src="<?php echo base_url();?>assets/images/t1.jpg" alt="product" class="img-responsive ">
				</a>
				...
				<div class="col-lg-3 col-md-6 col-sm-6 team-team">
				  <div class="our-team">
					<a href="#page">
					<img src="<?php echo base_url();?>assets/images/t2.jpg" alt="product" class="img-responsive ">
					<div class="team-content">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 team-team">
					<div class="our-team">
					  <a href="#page">
					  <img src="<?php echo base_url();?>assets/images/t3.jpg" alt="product" class="img-responsive ">
					  <div class="team-content">
						<h3 class="name"><a href="#page">Kellie Smith</a></h3>
				  ...
				  <div class="col-lg-3 col-md-6 col-sm-6 team-team">
					<div class="our-team">
					  <a href="#page">
					  <img src="<?php echo base_url();?>assets/images/t4.jpg" alt="product" class="img-responsive ">
					  <div class="team-content">
						<h3 class="name"><a href="#page">Kellie Smith</a></h3>
...
<div class="row">
	...
	<div class="col-lg-6 ">
		<img src="<?php echo base_url();?>assets/images/b3.jpg" alt="product" class="img-responsive about-me">
	</div>
